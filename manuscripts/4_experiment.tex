...
\hline
\textbf{Architecture} & \textbf{Baseline 1 (MATRA)} & \textbf{Baseline 3 (ADTree No Decay)} & \textbf{CAPS (Proposed)} \\
\hline
RAG Chatbot & 55.4 & 42.4 & \textbf{34.3} \\
Autonomous Agent & 70.2 & 58.1 & \textbf{51.3} \\
Model Router & 68.5 & 56.0 & \textbf{47.6} \\
\hline
\end{tabular}
